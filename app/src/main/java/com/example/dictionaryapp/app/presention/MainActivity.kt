...
import com.example.dictionaryapp.presention.MainState
import com.example.dictionaryapp.presention.MainUiEvents
import com.example.dictionaryapp.presention.MainViewModel
...
class MainActivity : ComponentActivity() {
    ...
    fun Meaning(
        ...
        Column(
            ...
            Text(
                text = "${index + 1}. ${meaning.partOfSpeach}",
                fontSize = 17.sp,
